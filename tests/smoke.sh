...
grep -q "BETABOT_MORTAL_TRUTH" "$ROOT/skills/betabots/scripts/thoughtful_browser_betabots.cjs"
grep -q "mortalTruthRules" "$ROOT/skills/betabots/scripts/thoughtful_browser_betabots.cjs"
